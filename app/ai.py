...
class AvalAIClient:
    ...
    async def extract(
        ...
        instructions = (
            ...
            "عبارت کامل زمان، شامل ساعت و صبح/عصر/شب را دقیقاً در due_raw نقل کن. "
            "برای همهٔ زمان‌ها due_at را null بگذار؛ محاسبهٔ زمان فقط با سامانه است. "
            "اگر کاربر فقط روز را گفت و ساعت نگفت، ساعت نساز و needs_confirmation=true بگذار. "
            "برای کارهای انجام‌شده در گذشته یا خاطرات، due_raw و due_at را null بگذار؛ یادآوری نساز. "
            "از حدس‌زدن تاریخ یا ساعت خودداری کن؛ اگر عبارت مبهم است needs_confirmation=true بگذار. "
            "احساسات را خوداظهاری ثبت کن، "
